...
- Unable to see unique water, foliage, and grass color in the Seasons world.
- Unable to see RGB colors (Geyser will still do its best to map RGB colors to default Minecraft
  colors).
