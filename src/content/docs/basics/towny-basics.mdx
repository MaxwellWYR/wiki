...
manage the town's bank, but not claim land. Ranks can be added or removed from players using the
...
- `/t claim outpost` - Allows the town to claim an outpost
- `/t outpost list` - Lists all the town's outposts
