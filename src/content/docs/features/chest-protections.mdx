...
### How to toggle Nolock mode

Use `/bolt mode nolock` to toggle Nolock mode on or off for yourself. While Nolock mode is on, any chests or other containers you place will **not** be automatically protected. Toggling it back off resumes normal auto-protection for anything you place afterward.
